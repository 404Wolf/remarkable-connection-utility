...
class EraserPen(QPen):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.vector:
            ...
            # This is a hack to get the eraser to look normal-ish,
            # assuming there will always be a white background. The
            # real way around this problem is to implement PDF
            # transparency groups.
            super(type(self), self).setColor(Qt.white)
